...
int pg_getpage(struct mm_struct *mm, int pgn, int *fpn, struct pcb_t *caller)
{
  ...
  { /* Page is not online, make it actively living */
    ...
    __swap_cp_page(caller->mram, vicpgn, caller->active_mswp, swpfpn); /* Copy target frame from swap to mem */
    __swap_cp_page(caller->active_mswp, tgtfpn, caller->mram, pgn);
    /* Update page table */
    pte_set_swap(&pte, 0, swpfpn); // Set swap information for the page
